...
public class PriceBetUSD
{
    // Constructor privado para EF Core
    private PriceBetUSD() { }

    // Constructor para crear nuevas apuestas de precio USD
    public PriceBetUSD(string userId, string ticker, double priceBet, int prize, double margin, DateTime endDate)
    {
        UserId = userId;
        Ticker = ticker;
