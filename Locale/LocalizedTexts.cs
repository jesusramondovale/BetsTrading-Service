      ...
      { "en", new Dictionary<string, string>()
        {
            ...
            { "newPasswordEmailBody", "Hello {0},\n\nYour account password has been successfully changed.\n\nYour new password is: {1}\n\nPlease delete this message immediately after reading it. If you did not request this change, contact Betrader support immediately.\n\nBest regards,\nBetrader Support Team" }
        }
      },
      { "es", new Dictionary<string, string>()
        {
            ...
            { "newPasswordEmailBody", "Hola {0},\n\nLa contraseña de su cuenta se ha cambiado correctamente.\n\nSu nueva contraseña es: {1}\n\nPor favor, borre este mensaje inmediatamente después de leerlo. Si usted no ha solicitado este cambio, póngase en contacto inmediatamente con el soporte de Betrader.\n\nUn saludo,\nEquipo de soporte de Betrader" }
        }
      },
      { "fr", new Dictionary<string, string>()
        {
            ...
            { "newPasswordEmailBody", "Bonjour {0},\n\nLe mot de passe de votre compte a été modifié avec succès.\n\nVotre nouveau mot de passe est : {1}\n\nVeuillez supprimer ce message immédiatement après l'avoir lu. Si vous n'êtes pas à l'origine de ce changement, contactez immédiatement le support de Betrader.\n\nCordialement,\nÉquipe de support Betrader" }
        }
      },
      { "it", new Dictionary<string, string>()
        {
            ...
            { "newPasswordEmailBody", "Ciao {0},\n\nLa password del tuo account è stata modificata con successo.\n\nLa tua nuova password è: {1}\n\nTi preghiamo di eliminare subito questo messaggio dopo averlo letto. Se non sei stato tu a richiedere questo cambiamento, contatta immediatamente il supporto di Betrader.\n\nCordiali saluti,\nTeam di supporto Betrader" }
        }
      },
      { "de", new Dictionary<string, string>()
        {
            ...
            { "newPasswordEmailBody", "Hallo {0},\n\nDas Passwort Ihres Kontos wurde erfolgreich geändert.\n\nIhr neues Passwort lautet: {1}\n\nBitte löschen Sie diese Nachricht sofort nach dem Lesen. Wenn Sie diese Änderung nicht selbst veranlasst haben, wenden Sie sich bitte umgehend an den Betrader-Support.\n\nMit freundlichen Grüßen,\nBetrader Support Team" }
        }
      },
