...
namespace BetsTrading_Service.Models
{
  ...
  public class BetZoneUSD
  {
    ...
    [JsonConstructor]
    public BetZoneUSD(int id, string ticker, double target_value, double bet_margin, DateTime start_date, DateTime end_date, double target_odds, int bet_type, int timeframe)
    {
      this.id = id;
      this.ticker = ticker;
      this.target_value = target_value;
    ...
    public BetZoneUSD(string ticker, double target_value, double bet_margin, DateTime start_date, DateTime end_date, double target_odds, int bet_type, int timeframe)
    {
      this.ticker = ticker;
      this.target_value = target_value;
      this.bet_margin = bet_margin;
